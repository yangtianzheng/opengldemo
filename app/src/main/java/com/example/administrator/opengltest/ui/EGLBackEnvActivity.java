...
import com.example.administrator.opengltest.camera.Filter.GrayFilter;
import com.example.administrator.opengltest.egl.GLES20BackEnv;
...
//        }
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(EGLBackEnvActivity.this, "保存成功->", Toast.LENGTH_SHORT).show();
